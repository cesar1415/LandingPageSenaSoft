...
<head>
	...
	<title>compra ropa deportiva</title>
	<link rel="stylesheet" href="{{asset('css/sub1.css')}}">
...
<form action="/php/insertar_subasta.php" method="post" enctype="multipart/form-data">
  ...
  <select multiple="multiple" size="5" id="producto a comprar " name="productos a comprar">
    <option value="3105">sueter  mujer</option>
    <option value="3106">sueter  hombre</option>
    <option value="3107">sueter niño</option>
    <option value="3108">sueter  niña </option>
    <option value="3109">bermudas mujer</option>
    <option value="3110">bermudas hombre</option>
    <option value="3111">bermudas niño</option>
     <option value="3111">bermudas niña</option>
