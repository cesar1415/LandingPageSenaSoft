...
<head>
	...
	<title>compra accesorios deportivos</title>
	<link rel="stylesheet" href="{{asset('css/sub3.css')}}">
...
<form action="/php/insertar_subasta.php" method="post" enctype="multipart/form-data">
  ...
  <select multiple="multiple" size="5" id="producto a comprar " name="productos a comprar">
    <option value="3105">gorras</option>
    <option value="3106">instrumentos de deporte</option>
    <option value="3107">medias </option>
    <option value="3109">balones</option>
    <option value="3110">bolsos</option>
    <option value="3111">accesorios extras</option>
